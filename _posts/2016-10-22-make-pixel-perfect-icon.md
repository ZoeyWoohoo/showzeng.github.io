...
> 本文为译文，原文链接：[点击进入原文](https://blog.ginetta.net/i-set-out-to-create-pixel-perfect-icons-heres-what-i-discovered-along-the-way-4e46378932df#.83n2lylog) 。你也可以在众成翻译上找到 [这篇文章](http://zcfy.cc/article/i-set-out-to-create-pixel-perfect-icons-here-s-what-i-discovered-along-the-way-1483.html) 。
...
- 在 General (常规) 选项中，将键盘增量设为 1px。这样，当你移动你的图标时，它们将留在像素网格中。
